...
#target_positions = [40,80,120,160]
...
async def Auto_motion():
    ...
    if count_reset:
        ...
        count_reset = False
        bug_Check = False
        Start_switch = False  # Start_switch 초기화
        for i in range(len(target_reached_flags)):
            target_reached_flags[i] = False  # target_reached_flags 초기화
